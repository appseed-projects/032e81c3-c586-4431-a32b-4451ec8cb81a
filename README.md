...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-09 16:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/032e81c3-c586-4431-a32b-4451ec8cb81a.git
$ cd 032e81c3-c586-4431-a32b-4451ec8cb81a
```
